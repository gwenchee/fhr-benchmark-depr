...
def beta_b(beta,sp): 
    ...
    beta: openmc.mgxs.mdgxs.Beta
        beta is created in the tallies_generation function in
        tallies.py
    sp: openmc.statepoint.StatePoint
        this statepoint.h5 file is created by running the openmc 
        executable on the xml files generated by the build_xml.py 
        files and when tallies.xml is generated by the 
        talllies_generation function in tallies.py
    Returns
    -------
    beff: float 
        Effective Delayed Neutron Fraction
    beff_err: float 
        Effective Delayed Neutron Fraction uncertainty
    """
...
def neutron_flux_e(sp,k,case): 
    ...
    plt.figure()
    plt.imshow(flux_conv['eg1'], interpolation='none', origin='lower',cmap='YlOrRd')
    plt.colorbar()
    ...
    plt.figure()
    plt.imshow(flux_conv['eg2'], interpolation='none', origin='lower',cmap='YlOrRd')
    plt.colorbar()
    ...
    plt.figure()
    plt.imshow(flux_conv['eg3'], interpolation='none', origin='lower',cmap='YlOrRd')
    plt.colorbar()
